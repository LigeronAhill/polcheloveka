              ...
              {field.value.length > 0 && (
                <div className="mt-2.5 flex items-center justify-start gap-2.5">
                  {field.value.map((tag: string) => (
                    <Badge
                      key={tag}
                      className="flex items-center justify-center gap-2 rounded-md border-none bg-light-800 px-4 font-medium text-[10px] text-light-400 capitalize dark:bg-dark-300 dark:text-light-500"
