        ...
        <>
            <div className="flex w-full flex-col-reverse justify-between gap-4 sm:flex-row sm:items-center">
                <h1 className="font-bold text-3xl text-dark-100 tracking-tighter dark:text-light-900">
                    Вопросы с меткой
                    <span
                        className="mx-2 font-mono font-normal text-4xl text-light-500 dark:text-light-500">{`"${tagTitle}"`}</span>
                </h1>
                <Link href={"/ask-question"} className="flex justify-end max-sm:w-full">
                    <Button
                        className="min-h-[46px] cursor-pointer bg-linear-129 from-primary-500 to-[#e2995f] px-4 py-3 text-light-900">
                        Задать вопрос
                    </Button>
                </Link>
            </div>
